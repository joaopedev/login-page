          ...
          <VStack flexDirection="row" spacing={8}>
            <Box>
              {/* <Text display="flex" alignItems="center">
                Hello, on this site you will be able to become a friend of Jassa
                and invite him to play with you.
              </Text> */}
        ...
        <GridItem display="grid" alignContent="center" w="100%" h="100%">
          ...
          >
            <VStack spacing={8}>
              ...
              <FormControl>
                <Input placeholder="exemple@gmail.com" type="email" />
                <FormHelperText p={2}>We'll never share your email.</FormHelperText>
              <InputGroup>
                <Input
                  p={2}
